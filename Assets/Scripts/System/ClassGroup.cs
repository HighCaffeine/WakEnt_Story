...
public class DataTable
{
    ...
    DataTable()
    {
        PlayerData = new System.Collections.Generic.List<PlayerData>();
        MatchingData = new System.Collections.Generic.List<MatchingData>();
        ReviewComment = new System.Collections.Generic.List<ReviewCommentData>();
        Event = new System.Collections.Generic.List<EventData>();
        Keyword = new System.Collections.Generic.List<Keyword>();
        BroadcastRecord = new System.Collections.Generic.List<BroadcastRecord>();
    }
}

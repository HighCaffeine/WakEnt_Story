...
/// 
    ...
    {
        return DataManager.Instance.ParsingBroadCastDataToString(broadCast.GetContents());
    }

    public string GetCurrentBroadcastType()
    {
        return DataManager.Instance.ParsingBroadCastDataToString(broadCast.GetBroadcastType());
    }
